...
infile <- "csv/Pancreas_Chrom_Numbers.csv"
...
grid <- expand.grid(
  pA = c(0.002, 0.003, 0.004),   
  pB = c(0.005, 0.01, 0.015),    
  w  = seq(0.001, 0.002, 0.003),   
  peakA  = c(44),              
  peakB  = seq(73, 78, 1),
  sigmaA_gain = seq(10, 16, 2),                  
  sigmaA_loss = seq(12, 16, 2),                  
  sigmaB_gain = seq(11, 51, 5),                 
  sigmaB_loss = seq(11, 51, 5),             
...
ggplot() +
  ...
  xlim(20, 125) +
  labs(
    title = "Markov Chain Model Fit vs. Observed Pancreas Adenocarcinoma Data",
